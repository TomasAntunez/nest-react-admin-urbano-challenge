...
import { Modal, Table, TableItem } from '../../shared/components';
...
export const CourseContentsTable: FC<ContentsTableProps> = ({
  data,
  isLoading,
  courseId,
  onContentsChange,
  ...
  const handleDelete = async () => {
    try {
      setIsDeleting(true);
      await courseContentService.delete(courseId, selectedContentId);
      onContentsChange();
      setDeleteShow(false);
    } catch (error) {
